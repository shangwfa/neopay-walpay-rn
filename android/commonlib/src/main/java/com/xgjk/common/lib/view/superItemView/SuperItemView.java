package com.xgjk.common.lib.view.superItemView;
...
//        defaultLinePadding = dip2px(context, 16);
     ...
     * @return 返回值
     */
    public SuperItemView setCbChecked(boolean checked) {
        isChecked = checked;
     ...
     * @return 返回对象
     */
    public SuperItemView setCbBackground(Drawable drawable) {
     ...
     * @return 返回对象
     */
    public SuperItemView setOnSuperTextViewClickListener(OnSuperTextViewClickListener listener) {
     ...
     * @return 返回
     */
    public SuperItemView setLeftTopViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftTopTV != null) {
                leftTopTV.setOnClickListener(new OnClickListener() {
                    @Override
     ...
     * @return 返回
     */
    public SuperItemView setLeftBottomViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftBottomTV != null) {
                leftBottomTV.setOnClickListener(new OnClickListener() {
                    @Override
     ...
     * @return 返回
     */
    public SuperItemView setLeftBottomView2IsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftBottomTV2 != null) {
                leftBottomTV2.setOnClickListener(new OnClickListener() {
                    @Override

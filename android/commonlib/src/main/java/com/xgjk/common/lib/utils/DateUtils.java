...
public class DateUtils {
	...
	public static final String now() {
		return convertDate2String(dateTimePattern);
	}

	public static final String nowDate(){return  convertDate2String(datePattern);}
	/**
	...
	public static final String convertDate2String(Date date) {
		return convertDate2String(date, dateTimePattern);
	}
	...
	public static final String convertDate2String(String strDate, String pattern) {
		return convertDate2String(strDate, dateTimePattern, pattern);
	}
	...
	public static final Date convertString2Date(String strDate) {
		return convertString2Date(strDate, dateTimePattern);
	}
	 ...
	 * 功能：判断输入日期是否是今年
	 */
	public static boolean isCurYear(String date){
		try {
			return today().substring(0,4).equals(date.trim().substring(0,4));
		}catch (Exception e){
			e.printStackTrace();
			return false;
		}

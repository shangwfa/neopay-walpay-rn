...
- (void)addTabBarItem:(UITabBarItem *)item {
    ...
    XGQBTabBarItem *tabBarItem = [[XGQBTabBarItem alloc] initWithItemImageRatio:self.itemImageRatio];
...
- (void)buttonClick:(XGQBTabBarItem *)tabBarItem {
...
- (void)layoutSubviews {
    ...
    for (int index = 0; index < count; index++) {
        ...
        XGQBTabBarItem *tabBarItem = self.tabBarItems[index];

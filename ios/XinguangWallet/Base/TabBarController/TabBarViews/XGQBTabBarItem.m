...
#import "XGQBTabBarBadge.h"

@interface XGQBTabBarItem()

@property (nonatomic, strong) XGQBTabBarBadge *tabBarBadge;

@end

@implementation XGQBTabBarItem
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.tabBarBadge = [[XGQBTabBarBadge alloc] init];

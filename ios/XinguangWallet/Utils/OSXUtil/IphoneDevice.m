...
+ (NSString*)deviceVersion
{
    ...
    if ([deviceString isEqualToString:@"iPad6,11"])     return @"iPad (5th Gen)";
    if ([deviceString isEqualToString:@"iPad6,12"])     return @"iPad (5th Gen)";
    if ([deviceString isEqualToString:@"iPad7,1"])      return @"iPad Pro 12.9 (2nd Gen)";
    if ([deviceString isEqualToString:@"iPad7,2"])      return @"iPad Pro 12.9 (2nd Gen)";

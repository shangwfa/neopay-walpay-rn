...
public class RegisterActivity extends BaseActivity<RegisterPresenter, ActivityRegisterLayoutBinding> implements RegisterContract.IView {
    ...
    private void handlerViewClick() {
        mViewBinding.registerPhone.getEditText().setOnFocusChangeListener((v, hasFocus) -> {
            handleRegisterPhoneLostFocus(hasFocus);
        });
                    ...
                    if (responseBean.getRegistered()) {
                        ...
                        loginDialog.setTitle(String.format(getString(R.string.str_phone_exist_tips)))
                                ...
                                .setEnsureListener(v1 -> {
                                    ...
                                    MainRouter.getSingleton().jumpToLoginPage(registerPhone);
                                })
                                .HideCancelLayout()
                                .show();
                    }

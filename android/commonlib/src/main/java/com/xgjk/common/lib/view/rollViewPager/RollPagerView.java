package com.xgjk.common.lib.view.rollViewPager;
...
import com.xgjk.common.lib.view.rollViewPager.hintview.ColorPointHintView;
...
public class RollPagerView extends RelativeLayout implements ViewPager.OnPageChangeListener {
	...
	private void loadHintView(){
		...
		lp.setMargins(0,0, DensityUtils.dip2px(mHintView.getContext(),16),0);
...
//		mViewPager.addOnPageChangeListener(this);
	...
	private void setViewPagerlistener() {
		cur=mAdapter.getCount()*50-1;
		getViewPager().setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
			@Override
			...
			public void onPageSelected(int position) {
				cur=position%mAdapter.getCount();

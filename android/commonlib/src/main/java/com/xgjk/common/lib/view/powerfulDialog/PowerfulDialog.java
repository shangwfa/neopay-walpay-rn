...
public class PowerfulDialog extends Dialog {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setWidthAndHeightForPercent(float pWidth, float pHeight) {
         ...
         * @return
         */
        public Builder setAnimations(int animStyle) {
        ...
        public Builder setDialogView(int layoutResId) {
            this.P.mView = null;
         ...
         * @return
         */
        public Builder setIsPopSoftKey(boolean ispopsoftkey) {//设置是否弹出软键盘
         ...
         * @return
         */
        public Builder setText(int viewId, CharSequence text) {//设置文本
         ...
         * @return
         */
        public Builder setTextColor(int viewId, int colorRes) {//设置文本
         ...
         * @return
         */
        public Builder setImage(int viewId, int imgRes) {//设置文本
         ...
         * @return
         */
        public Builder setViewVisiable(int viewId, int visibilityMode) {//设置显示隐藏功能
         ...
         * @return
         */
        public Builder setOnclickListener(int viewId, View.OnClickListener listener) {//设置点击事件
            this.P.mClickArray.put(viewId, listener);
            return this;
        }


        public <T extends View> Builder viewAction(int viewid, IAction<T> action) {
            final T actionView = mDialog.getView(viewid);
            action.action(actionView,mDialog);
            return this;
        }
    }
}
